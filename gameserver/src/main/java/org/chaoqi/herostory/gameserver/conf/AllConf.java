package org.chaoqi.herostory.gameserver.conf;
...
public final class AllConf {
     ...
     *  MySql 数据库
     */
    static public final String MYSQL_DB = "org/chaoqi/herostory/gameserver";
     ...
     * 启动 RocketMQ
     */
    static public final boolean ROCKETMQ_ENABLE = false;
